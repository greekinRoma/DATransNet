...
class GFEM(nn.Module):
    def __init__(self,channels,h):
        ...
        self.sp = TGMandTRM(h=h,c=channels)
...
class DATransNet(nn.Module):
    def __init__(self,  n_channels=1, n_classes=1, img_size=256, vis=False, mode='train', deepsuper=True):
        ...
        self.contras4 = ExpansionContrastModule(in_channels=in_channels*8,out_channels=in_channels*8,width=img_size//8,height=img_size//8,shifts=[1])
        self.GFEM = GFEM(channels=in_channels*8,h=img_size//16)
